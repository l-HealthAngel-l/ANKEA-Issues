...
* Added 404 page.
* Added Spoiler Alert page.
* Updated Chairs category to match current game version (0.4.17).
* Added Blue Bench.
* Added Fancy Bench.
* Added Gray Fancy Wooden Chair.
* Added Plastic Chair. (Will be reported about its name in Obenseuer issues)
* Added Saddle Stool.
* Moved Malone's Plastic Chair into Quest Furniture category.
* Updated Beach Chair information.
...
* Changed in all Bathroom category furniture pages "One Stop Store" into "One Stop Shop"
